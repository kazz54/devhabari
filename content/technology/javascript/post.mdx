...
*Kumbuka tukwambwa hii inatofa fura yakutumi kipengele kimoja mara kadhaa kwa jinsi unavyo hitaji*
...
```html
    // Hii haitafanya kazi!
    <h1>Mambo ya kufanya Pablo Pa</h1>
    <img
      src="" 
      alt="pablo pa" 
      class="test"
    ...
    <ul>
       <li>Imarisha maabara
        <li>Andaa lectures kwa ajili ya kemia
        <li>Utafiti juu ya sayari
    </ul>
```
...
<>
    ...
    <ul>
       <li>Imarisha maabara</li>
        <li>Andaa lectures kwa ajili ya kemia</li>

...
Naam, baada ya dom kutubainikia na JSX kujitokeza ingependeza kama tunge viangalia vipengele vya react 
kwa ndani kidogo ilikuweza kuielewa na kuitumia React kwa ufasaha kwenye kuendeleza au kujenga
**vipengela anavyo ingiliana navyo mtumiaji** kwa maana ya **"user interfaces" (UI)** kwenye muktadha huu.

Kumbuka tu kwamba **kipengele** cha reat ni **kazi** ya javascript ambayo unaweza kuiwekea madegeshee kwa kutumia alama za juu 
...
chochote ili mradi liwe namantiki kwa wengine watakao soma code zako. weka

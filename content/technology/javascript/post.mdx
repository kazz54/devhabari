...
Wala sisahau kutupia aina flani ya msaidizi **React.StrictMode** ambaye atatusaidia kuandika vipengele  vya react vyenye **ubora** kwakua inatoa **onyo** kwenye **console** pale kunapotokea **ukiukaji** wa **sheria** wakati tunatengeneza **vipengele**. Tukiwa bado tunazungumzia **vipengele** naonyesha **kipengele** cha **hati** ya **hml** kwa kutumia **jsx** kuleta athari kwenye alama za juu za html na tumia extension ya `javascript` inayo julikana kama `JSX`, 

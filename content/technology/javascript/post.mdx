...
```javascript
function List() {
  const salaam = "Salam kutoka Function Component!";
...
export default List;
```
ilikutoa kipengele cha react ndani ya kipengele cha kazi "Fuction component"
utafafanua kipengele kingine nakutoa kama kipengele cha HTML kwa kutumia jsx
wepesi huu unakuwezesha kuwa na maamuzi ya jinsi na wapi pakutoa kipengele cha react
...
export default function TodoList() {
  return (
    <div style={mtumiaji.theme}>
      ...
      />
      <ul>
        <li>Imarisha maabara</li>
        <li>Andaa lectures kwajili ya kemia</li>
        <li>Utafiti juu ya sayari</li>
      </ul>
    </div>
  );
}

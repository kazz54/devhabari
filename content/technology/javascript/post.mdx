...
`createRoot` **React** itatengeneza mzizi kwenye **Domnode**, na kuchua utawala wa dom ndani yake.
React dom ni dom ya natharia **"virtual Dom"**, ukiachilia mbali uwezo wa virtual dome 
...
kwenye Dom kivinjari nimetumia `root.render` 

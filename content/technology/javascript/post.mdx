...
hilo natumia Fragment `<> </>` na hii ni kwa sababu Jsx nyuma yapazia inabadilishwa nakua kitu cha javascript hauwezi kurudisha vitu 
viwili kutoka kwenye kazi bila kufunga kwenye array "safu" kwa hoja hii huwezi kurudisha tag mbili za jsx bila kuzifunga kwenye tag
...
imerudishwa kwenye mabano mustachi `{}` **cul brec** kama `{salaam}`
...
Zichukulie props kama nobe unazotumia kurekibishia sauti, treble, bass n.k

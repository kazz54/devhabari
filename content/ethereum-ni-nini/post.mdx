...
Ethereum imeundwa ili ikuwe, iweze kuprogramiwa, usalama na kugatuliwa. Ni blockchain ambayo nichaguo kwa waendelezaji na makampuni ya biyashara 
...
Hii ina manisha data zetu binafsi, tarifa za kiuchumi na mengineyo kwa kiasi kikubwa zime hifadhiwa kwenye computer za watu wengine kwenye mtandao wa internet kwenye server zinazo milikiwa na makampuni kama vile Google, Facebook au Pay Pal hata makala haya ya Devhabari yame hifadhiwa kwenye server ambayo inadhibitiwa na mtu wa tatu 

Huu muundo unaweza kuwa tatizo kwa mujibu ya watetizi wa mfumo uliyo gatuliwa, ina manisha udhibiti mdogo wa moja kwa moja kwa watumiaji na huwacha wazi fursa ya kudhibitiwa, ambapo mtu watatu atakapo ingilia na kumzuia mtumiaji kufanya kitendo chochote kile, iwe niku nunua hisa au kutuma ujumbe kwenye mitandao ya kijamii au kuzuia kila kitu pamoja.
...
Kwenye ulimwengu wa blockchain, **mikataba janja** ina andikwa kama `code` hizi `code` pamoja na vigezo, masharti na hali ya mkataba zina patikana hadharani kwenye leja zilizo gatuliwa naku sambanzwa zina rekodi shughuli au vitalu.

Pale litakapo tokea **tukio** lililo `ainishwa` au `muda wake kumalizika` kwenye **mkataba janja** `itasababisha code na makubaliano yatatokea au sitishwa`. 
...
Mikataba janja haihitaji kuendeshwa au kufuatiliwa na waamuzi, tafsiri yake nikwamba una udhibiti wote wa makubaliano. Blockchain pia inahakikisha data zilizo wasilishwa na pande zote ziko sahihi 
...
NFT zinaendelezwa kwenye kila aina ya bidhaa. Mfn kwa mashabiki wa michezo wanaweza kununua token za michezo ambazo zina fahamika kama token za mashabiki kutoka kwa wana michezo wao wanao wapenda, ambazo zinaweza kutumika kama kadi za biyashara. Baadhi ya hizi NFT ni picha zina funana na kadi ya biyashara, na zingine ni video za kumbu kumbu za matukio ya kihistoria ya mwana michezo.
...
Baadhi ya majimbo nchini Marekani yameanza kuruhusu utumiaji wa mikataba janja na teknologia ya blockchain mfn California wanaruhusu leseni za ndoa zitolowe kwa kutumia teknologia ya blockchain na Arizona wame ruhusu mikataba ya kisheria inayotekelezeka itengenezwe kwa kutumia mikataba janja 
...
Pamoja vipengele vyote hivi vinafanya kazi kutengeneza mfumo wa ikolojia ambao una shawishi maudhui yenye viwango vya juu 
...
**Wavuti** kama vile `brave` tayari imesha fanya hivi kwa kutengeneza wavuti "browser" ambayo ina kuja nje ya boksi ikiwa tayari imejengwa na wallet ndani kwa ndani ambayo watu wanaweza kuitumia kutoa bakshishi kwa watengenezaji wa maudhui wanao wakubali. Brave ili jengwa ili kuwapa nguvu zaidi watengenezaji kuliko makampuni ya matangazo ambayo hua yana chukuwa kiasi fulani cha fedha.
